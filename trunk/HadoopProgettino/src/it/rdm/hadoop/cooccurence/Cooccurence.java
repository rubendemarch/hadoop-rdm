...
public class Cooccurence extends Configured implements Tool {
  ...
  public Cooccurence (String[] args) {
    ...
    //Creates a temporary output directory for first job, located next to final output directory.
  ...
  public static void main(String args[]){
	...
	// Removes temporary folder generated by first job
	    try {
	    	System.out.println("Deleting temporary folder");
			delete(new File(outputDir.toString()));
		} catch (IOException e) {
			// If outputDir doesn't exist, we're already done.
		}
	    System.exit(res);
		}
  }
